...
The algorithm jumps right to the predictions. Let's look at a visualisation
based on our simple data from the first few weeks of class:

- [slides](../extra/knn.pdf)
