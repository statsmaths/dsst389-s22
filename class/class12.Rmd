...
them directly if you want to do some direct EDA on the object. Otherwise, we
return again to the idea of building an interactive visualisation using
JavaScript. We can write all of the model data as a local JSON file with
